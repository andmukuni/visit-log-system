...
function OrganisationDetailSidebar({ organisation, onClose, onEdit }) {
    ...
    <aside className="hidden w-full shrink-0 flex-col border-t border-gray-200 bg-white lg:flex lg:w-[320px] lg:border-l lg:border-t-0">
      ...
      <div className="px-4 py-3 sm:px-5">
        ...
        <section className="mt-4 sm:mt-5">
          ...
          <div className="mt-1.5 grid grid-cols-[16px_1fr] gap-x-3 sm:mt-2">
            <DetailRow icon={MapPin} label="Sites & Branches" value={String(organisation.site_count ?? 0)} />
            <DetailRow icon={Building2} label="Buildings" value={String(organisation.building_count ?? 0)} />
            <DetailRow icon={DoorClosed} label="Offices" value={String(organisation.office_count ?? 0)} />
      ...
      <div className="flex shrink-0 items-center justify-end gap-2 border-t border-gray-200 px-4 py-2.5 sm:px-5">
        ...
        <Link
          ...
          className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-navy-900 text-white transition-colors hover:bg-navy-800"
        >
  ...
  const handleSave = async () => {
    ...
    try {
      if (editing?.id) {
        ...
        await visitorApi.createOrganisation(form);
        ...
        <div className="fixed inset-0 z-50 flex flex-col bg-white lg:hidden">
          ...
          <div className="min-h-0 flex-1 overflow-y-auto px-4 py-4">
            ...
            <div className="mt-4 grid grid-cols-[16px_1fr] gap-x-3">
              ...
              <DetailRow icon={Network} label="Departments" value={String(selected.department_count ?? 0)} />
